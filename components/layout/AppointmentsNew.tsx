...
const Appointments: React.FC = () => {
  ...
  const appointments = [
    { id: 1, title: '1st Consultation', with: 'Sam Lewis', date: new Date(2024, 2, 11, 9, 20), end: new Date(2024, 2, 11, 11, 30) },
    { id: 2, title: 'Follow up', with: 'Suzie Smith', date: new Date(2024, 2, 20, 11, 40), end: new Date(2024, 2, 20, 13, 30) },
    { id: 3, title: 'Review', with: 'Sam Lewis', date: new Date(2024, 2, 11, 9, 20), end: new Date(2024, 2, 11, 11, 30) },
    { id: 4, title: 'Follow up', with: 'Suzie Smith', date: new Date(2024, 2, 20, 11, 40), end: new Date(2024, 2, 20, 13, 30) },
    { id: 5, title: 'Review', with: 'Sam Lewis', date: new Date(2024, 2, 11, 9, 20), end: new Date(2024, 2, 11, 11, 30) },
    { id: 6, title: 'Follow up', with: 'Suzie Smith', date: new Date(2024, 2, 20, 11, 40), end: new Date(2024, 2, 20, 13, 30) },
  ];
  ...
  return (
    <div className="p-4 bg-white shadow-md rounded-lg ">
      <h2 className="text-primary-color font-semibold text-lg text-center mb-4">Upcoming appointment</h2>
      <SmallCalendarNew onSelectDate={setSelectedDate} selectedDate={selectedDate} />
      {selectedDate && (
        <div className="mb-4">
            ...
            {filteredAppointments.length > 0 ? (
              filteredAppointments.map((upcomingAppointments, index) => (
                <AppointmentCardNew
                  ...
                  date={format(new Date(upcomingAppointments.date), 'EEEE, MMMM dd, yyyy')}
      ...
      <h2 className="text-primary-color font-semibold text-lg text-center mt-4 mb-4">Appointment history</h2>
      <div className="overflow-y-auto max-h-64">
        ...
        {appointments.map((appointment) => (
          <div key={appointment.id} className="mb-8 flex items-start">
            ...
            <div className="ml-4">
              ...
              {format(appointment.date, 'hh:mm a')} - {format(appointment.end, 'hh:mm a')}
              </div>
