...
const Achievements: React.FC<AchievementsProps> = ({ hours, reps, totalReps }) => {
  return (
    <div className="bg-white rounded-2xl shadow p-6 max-w-[350px]">
      ...
      <div className="block md:flex justify-center sm:justify-start items-center space-y-2 sm:space-y-0 sm:items-center space-x-0 sm:space-x-10 pl-9 sm:pl-8 pr-0 mt-3">
