...
const Achievements: React.FC<AchievementsProps> = ({ hours, reps, totalReps }) => {
  return (
    <div className="bg-white rounded-2xl shadow p-6 ">
      ...
      <div className="block md:flex justify-center sm:justify-start items-center space-y-2 sm:space-y-0 sm:items-center space-x-0 sm:space-x-10 lg:space-x-6 pl-9 lg:pl-2 sm:pl-8 pr-0 mt-3">
